                        ...
                        <div class="p-4 md:p-12 text-center lg:text-left">
                            ...
                            >
                                ...
                                <a
                                    ...
                                    >Vannes - 47.6442391° N, -2.7787762° W</a
                                >
                            </p>
                            <p class="pt-8 text-sm">
                                J'ai commencé le développement web comme un hobby, aujourd'hui je cherche à en faire mon
                                métier.
                            </p>
                            ...
                            <div
                                class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between opacity-80"
                            >
                                <a
                                    href="https://linkedin.com/in/ebriantais/"
                                    target="_blank"
                                    v-tippy="{ content: 'ebriantais' }"
                                    ><svg
                                    ...
                                    >
                                        ...
                                        /></svg
                                ></a>
                                <a href="https://github.com/CeansBzh" target="_blank" v-tippy="{ content: 'CeansBzh' }"
                                    ><svg
                                        class="h-6 fill-current text-gray-600 hover:text-green-700"
                                        role="img"
                                        viewBox="0 0 24 24"
                                ...
                                ></a>
                                <a
                                    href="https://www.instagram.com/elouan_brnts"
                                    target="_blank"
                                    v-tippy="{ content: 'elouan_brnts' }"
                                    ><svg
                                        class="h-6 fill-current text-gray-600 hover:text-green-700"
                                        role="img"
                                        viewBox="0 0 24 24"
                                    ...
                                    >
                                        ...
                                        /></svg
                                ></a>
                                <a href="https://twitter.com/CeansBzh" target="_blank" v-tippy="{ content: 'CeansBzh' }"
                                    ><svg
                                        class="h-6 fill-current text-gray-600 hover:text-green-700"
                                        role="img"
                                        viewBox="0 0 24 24"
...
#mobile-photo {
    background-image: url('/src/assets/photo-mini.jpg');
}
